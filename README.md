...
MicroserviÃ§o para **gerenciamento de ofertas e promoÃ§Ãµes**. Controla campanhas promocionais, descontos dinÃ¢micos, cupons personalizados, ofertas geolocalizada, sistema de recomendaÃ§Ãµes IA, cashback e programa de fidelidade.

### ðŸŽ¯ Principais Funcionalidades

- ðŸŽ **PromoÃ§Ãµes**: Campanhas e ofertas especiais
- ðŸŽ« **Cupons**: CÃ³digos de desconto
- ðŸ’° **Cashback**: Sistema de reembolso
- ðŸŽ¯ **PersonalizaÃ§Ã£o**: Ofertas customizadas
- ðŸ“ **GeolocalizaÃ§Ã£o**: Ofertas por regiÃ£o
- ðŸ¤– **IA**: RecomendaÃ§Ãµes inteligentes
- ðŸ“Š **Performance**: MÃ©tricas de conversÃ£o
- â° **Agendamento**: Ofertas programadas
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Offer;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
`
...
`ash
# Build da imagem
docker build -t PAM_MS_Offer.ToLower() .
...
- **Local**: http://localhost:5012/swagger
- **ProduÃ§Ã£o**: https://api.pam.com/PAM_MS_Offer.ToLower()/swagger
...
curl -X GET "http://localhost:5012/api/v1/..." \
...
az webapp deploy --resource-group PAM --name PAM_MS_Offer --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Offer.ToLower() registry.azurecr.io/pam/PAM_MS_Offer.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Offer.ToLower():latest
`
...
- **ðŸ› Issues**: [GitHub Issues](https://github.com/EmmanuelSMenezes/PAM_MS_Offer/issues)
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Offer/wiki)
