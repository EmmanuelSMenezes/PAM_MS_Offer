...
MicroserviÃ§o para gerenciamento de ofertas e promoÃ§Ãµes. Controla campanhas, descontos, cupons, ofertas personalizadas e sistema de recomendaÃ§Ãµes.
...
2. **Execute o container**
   `ash
   docker run -p 5012:5012 -e ConnectionStrings__DefaultConnection="sua-connection-string" PAM_MS_Offer.ToLower()
   `

## ðŸ“š DocumentaÃ§Ã£o da API

A documentaÃ§Ã£o completa da API estÃ¡ disponÃ­vel via Swagger UI:
- **Desenvolvimento**: http://localhost:5012/swagger
